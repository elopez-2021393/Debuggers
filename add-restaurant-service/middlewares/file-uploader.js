...
export const uploadRestaurantPhoto = createCloudinaryUploader(
    'add-restaurant/restaurants'
);

export const uploadMenuPhoto = createCloudinaryUploader(
    'add_restaurant/menu'
);
...
export const deleteCloudinaryImage = async (publicId) => {
    ...
    if (publicId.includes('DebuggersEats_Logo')) return;
